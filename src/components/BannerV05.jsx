...
const BannerV05 = ({
  ...
  subText = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi arcu urna, interdum sit amet nibh ac, pulvinar placerat lacus. Ut lobortis quam vel ligula semper laoreet. Fusce non iaculis erat, eu gravida tortor",
  btnText = "View more",
  btnLink = "product",
}) => {
  return (
