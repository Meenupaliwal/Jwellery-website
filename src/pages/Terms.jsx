...
/>
        ...
        <li className="faq-item" id="myAccount">
          ...
          <div className="faq_wrap" id="my-account">
            ...
            <div className="accordion-faq accor-mn-pl">
              ...
              >
                <div className="accordion-body">
                  <p className="h6">
                    Simply add your favorite items to the shopping cart, then
                    proceed to checkout where you fill in your shipping and
                    payment details before confirming the purchase.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="accordion-faq accor-mn-pl">
              ...
              <div id="lorem2" className="collapse" data-bs-parent="#my-account">
                <div className="accordion-body">
                  <p className="h6">
                    In hac habitasse platea dictumst. Integer venenatis elit
                    magna, eget auctor purus vestibulum volutpat. Maecenas
                    hendrerit fringilla arcu, eu euismod tellus euismod quis.
                    Orci varius natoque penatibus et magnis dis parturient
                    montes, nascetur ridiculus mus. Duis purus dolor, sagittis
                    vitae massa eget, vestibulum varius ipsum. Quisque vitae leo
                    congue nisl pharetra ornare tempus quis diam. Fusce a orci
                    fringilla arcu blandit commodo id venenatis ante. Quisque
                    quis pretium ante.
                  </p>
                </div>
              </div>
            ...
            <div className="accordion-faq accor-mn-pl">
              ...
              >
                <span className="text h5">
                  3. Maecenas rhoncus neque eu neque maximus auctor congue sed
                  erat.
                </span>
                <span className="icon">
                  <span className="ic-accordion-custom"></span>
              ...
              <div id="lorem3" className="collapse" data-bs-parent="#my-account">
                <div className="accordion-body">
                  <p className="h6">
                    In hac habitasse platea dictumst. Integer venenatis elit
                    magna, eget auctor purus vestibulum volutpat. Maecenas
            ...
            <div className="accordion-faq accor-mn-pl">
              ...
              <div id="lorem5" className="collapse" data-bs-parent="#my-account">
                <div className="accordion-body">
                  <p className="h6">
                    In hac habitasse platea dictumst. Integer venenatis elit
                    magna, eget auctor purus vestibulum volutpat. Maecenas
  ...
  <div className="faq_wrap" id="order-and-purchase">
    <div className="accordion-faq accor-mn-pl">
      ...
      <div id="lorem2-1" className="collapse" data-bs-parent="#order-and-purchase">
        <div className="accordion-body">
          <p className="h6">
    ...
    <div className="accordion-faq accor-mn-pl">
      ...
      >
        <span className="text h5">
          2. Suspendisse et sem in quam maximus imperdiet ac nec nunc.
        </span>
        <span className="icon">
          <span className="ic-accordion-custom"></span>
        </span>
      </div>
      <div id="lorem2-2" className="collapse" data-bs-parent="#order-and-purchase">
        <div className="accordion-body">
          <p className="h6">
            Simply add your favorite items to the shopping cart, then proceed to checkout where you fill in
            your shipping and payment details before confirming the purchase.
    ...
    <div className="accordion-faq accor-mn-pl">
      ...
      >
        <span className="text h5">3. Cras fringilla ante sit amet ullamcorper placerat.</span>
        <span className="icon">
          <span className="ic-accordion-custom"></span>
        </span>
      </div>
      <div id="lorem2-3" className="collapse" data-bs-parent="#order-and-purchase">
        <div className="accordion-body">
          <p className="h6">
            Simply add your favorite items to the shopping cart, then proceed to checkout where you fill in
            your shipping and payment details before confirming the purchase.
    ...
    <div className="accordion-faq accor-mn-pl">
      ...
      >
        <span className="text h5">4. Donec vestibulum leo nec erat congue laoreet.</span>
        <span className="icon">
          <span className="ic-accordion-custom"></span>
        </span>
      </div>
      <div id="lorem2-4" className="collapse" data-bs-parent="#order-and-purchase">
        <div className="accordion-body">
          <p className="h6">
            Simply add your favorite items to the shopping cart, then proceed to checkout where you fill in
            your shipping and payment details before confirming the purchase.
    ...
    <div className="accordion-faq accor-mn-pl">
      ...
      >
        <span className="text h5">
          5. Vestibulum ac elit et ligula tincidunt suscipit finibus vel est.
        </span>
        <span className="icon">
          <span className="ic-accordion-custom"></span>
        </span>
      </div>
      <div id="lorem2-5" className="collapse" data-bs-parent="#order-and-purchase">
        <div className="accordion-body">
          <p className="h6">
            Simply add your favorite items to the shopping cart, then proceed to checkout where you fill in
            your shipping and payment details before confirming the purchase.
...
<li className="faq-item" id="returnsRefunds">
  ...
  <div className="faq_wrap" id="return-and-refund">
    <div className="accordion-faq accor-mn-pl">
      ...
      >
        <span className="text h5">1. Nullam elementum diam vitae posuere dignissim.</span>
        <span className="icon">
          <span className="ic-accordion-custom"></span>
        </span>
      </div>
      <div id="lorem3-1" className="collapse" data-bs-parent="#return-and-refund">
        <div className="accordion-body">
          <p className="h6">
            Simply add your favorite items to the shopping cart, then proceed to checkout where you fill in
            your shipping and payment details before confirming the purchase.
    ...
    <div className="accordion-faq accor-mn-pl">
      ...
      >
        <span className="text h5">2. Morbi eget justo sit amet lacus scelerisque feugiat.</span>
        <span className="icon">
          <span className="ic-accordion-custom"></span>
        </span>
      </div>
      <div id="lorem3-2" className="collapse" data-bs-parent="#return-and-refund">
        <div className="accordion-body">
          <p className="h6">
            Simply add your favorite items to the shopping cart, then proceed to checkout where you fill in
            your shipping and payment details before confirming the purchase.
    ...
    <div className="accordion-faq accor-mn-pl">
      ...
      >
        <span className="text h5">3. Mauris vel diam a dui consectetur vehicula.</span>
        <span className="icon">
          <span className="ic-accordion-custom"></span>
        </span>
      </div>
      <div id="lorem3-3" className="collapse" data-bs-parent="#return-and-refund">
        <div className="accordion-body">
          <p className="h6">
            Simply add your favorite items to the shopping cart, then proceed to checkout where you fill in
            your shipping and payment details before confirming the purchase.
    ...
    <div className="accordion-faq accor-mn-pl">
      ...
      >
        <span className="text h5">
          4. Pellentesque aliquam leo in justo blandit, quis efficitur nulla facilisis.
        </span>
        <span className="icon">
          <span className="ic-accordion-custom"></span>
        </span>
      </div>
      <div id="lorem3-4" className="collapse" data-bs-parent="#return-and-refund">
        <div className="accordion-body">
          <p className="h6">
            Simply add your favorite items to the shopping cart, then proceed to checkout where you fill in
            your shipping and payment details before confirming the purchase.
    ...
    <div className="accordion-faq accor-mn-pl">
      ...
      >
        <span className="text h5">5. Ut volutpat justo sed lorem luctus semper.</span>
        <span className="icon">
          <span className="ic-accordion-custom"></span>
        </span>
      </div>
      <div id="lorem3-5" className="collapse" data-bs-parent="#return-and-refund">
        <div className="accordion-body">
          <p className="h6">
            Simply add your favorite items to the shopping cart, then proceed to checkout where you fill in
            your shipping and payment details before confirming the purchase.
...
<li className="faq-item" id="shippingTracking">
  ...
  <div className="faq_wrap" id="shipping-and-tracking">
      ...
      >
        <div className="accordion-body">
          <p className="h6">
            ...
            checkout where you fill in your shipping and payment details before
    ...
    <div className="accordion-faq accor-mn-pl">
      ...
      >
        <span className="text h5">
          4. Pellentesque aliquam leo in justo blandit, quis efficitur nulla
          facilisis.
        </span>
        <span className="icon">
          <span className="ic-accordion-custom"></span>
...
<li className="faq-item" id="otherTopic">
  ...
  <div className="faq_wrap" id="orther-topic">
    ...
    <div className="accordion-faq accor-mn-pl">
      ...
      <div id="lorem5-1" className="collapse" data-bs-parent="#orther-topic">
        <div className="accordion-body">
          <p className="h6">
            Simply add your favorite items to the shopping cart, then proceed to
            checkout where you fill in your shipping and payment details before
    ...
    <div className="accordion-faq accor-mn-pl">
      ...
      <div id="lorem5-2" className="collapse" data-bs-parent="#orther-topic">
        <div className="accordion-body">
          <p className="h6">
            Simply add your favorite items to the shopping cart, then proceed to
            checkout where you fill in your shipping and payment details before
    ...
    <div className="accordion-faq accor-mn-pl">
      ...
      <div id="lorem5-3" className="collapse" data-bs-parent="#orther-topic">
        <div className="accordion-body">
          <p className="h6">
            Simply add your favorite items to the shopping cart, then proceed to
            checkout where you fill in your shipping and payment details before
    ...
    <div className="accordion-faq accor-mn-pl">
      ...
      <div id="lorem5-4" className="collapse" data-bs-parent="#orther-topic">
        <div className="accordion-body">
          <p className="h6">
            Simply add your favorite items to the shopping cart, then proceed to
            checkout where you fill in your shipping and payment details before
    ...
    <div className="accordion-faq accor-mn-pl">
      ...
      <div id="lorem5-5" className="collapse" data-bs-parent="#orther-topic">
        <div className="accordion-body">
          <p className="h6">
            Simply add your favorite items to the shopping cart, then proceed to
            checkout where you fill in your shipping and payment details before
